...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    spread = spread / 100
    exchange_rate_with_spread = exchange_rate * (1 + spread)
    exchangeable_value = budget / exchange_rate_with_spread
    number_of_bills = get_number_of_bills(exchangeable_value, denomination)
