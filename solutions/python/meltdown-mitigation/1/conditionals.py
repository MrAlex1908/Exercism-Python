...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    product_of_tempreture_and_neytrons = temperature * neutrons_emitted
    if temperature < 800 and neutrons_emitted > 500 and product_of_tempreture_and_neytrons < 500000:
        return True
    else:
        return False
...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    efficiency_percantage_value = (generated_power / theoretical_max_power) * 100
    if efficiency_percantage_value >= 80: 
        return "green"
    elif efficiency_percantage_value >= 60:
        return "orange"
    elif efficiency_percantage_value >= 30: 
        return "red"
    else: 
        return "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    current_reactor_value = temperature * neutrons_produced_per_second
    lower_threshold = threshold / 100 * 90 
    upper_threshold = threshold / 100 * 110
    if current_reactor_value < lower_threshold:
        return "LOW"
    elif current_reactor_value <= upper_threshold: 
        return "NORMAL"
    else:
        return "DANGER"